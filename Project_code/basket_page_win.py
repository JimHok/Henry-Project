...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.basketScrollAreaWidgetContents.setObjectName(
            u"basketScrollAreaWidgetContents")
        ...
        self.all_food_price_label.setAlignment(
        ...
        self.delivery_fee_label.setAlignment(
            Qt.AlignRight | Qt.AlignTrailing | Qt.AlignVCenter)
        ...
        self.total_price_label.setAlignment(
            Qt.AlignRight | Qt.AlignTrailing | Qt.AlignVCenter)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.basket_shop_name.setText(
            QCoreApplication.translate("Dialog", u"Shop name", None))
        self.placeOrderButton.setText(
            QCoreApplication.translate("Dialog", u"Place Order", None))
        self.basket_shop_km.setText(
            QCoreApplication.translate("Dialog", u"10 km", None))
        self.basket_shop_mins.setText(
            QCoreApplication.translate("Dialog", u"50 mins", None))
        self.fixDeliveryToText.setText(
            QCoreApplication.translate("Dialog", u"Delivery to", None))
        self.addressLineEdit.setPlaceholderText(
            QCoreApplication.translate("Dialog", u" Address", None))
        self.fixMyOrderText.setText(
            QCoreApplication.translate("Dialog", u"My Order", None))
        self.fixFoodText.setText(
            QCoreApplication.translate("Dialog", u"Food", None))
        self.fixDeliveryFeeText.setText(
            QCoreApplication.translate("Dialog", u"Delivery fee", None))
        self.fixTotalText.setText(
            QCoreApplication.translate("Dialog", u"Total", None))
        self.all_food_price_label.setText(
        ...
        self.fixPaymentMethodText.setText(
            QCoreApplication.translate("Dialog", u"Payment method", None))
        self.paymentMethodComboBox.setItemText(
            0, QCoreApplication.translate("Dialog", u"Cash", None))
        self.paymentMethodComboBox.setItemText(
            1, QCoreApplication.translate("Dialog", u"Rabbit Line Pay", None))
        self.paymentMethodComboBox.setItemText(
            2, QCoreApplication.translate("Dialog", u"K PLUS", None))
        self.paymentMethodComboBox.setItemText(
            3, QCoreApplication.translate("Dialog", u"SCB EASY", None))
